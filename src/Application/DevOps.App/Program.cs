...
using DevOps.App.ExampleProviders;
    ...
    public class Program
    {
        ...
        private static void ConfigureOpenApi(WebApplicationBuilder builder)
        {
            ...
            builder.Services.AddSwaggerGen(swaggerGenerationOptions =>
            {
                ...
                swaggerGenerationOptions.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "DevOps.App.Open-Api.xml"));
...
//#endif
                ...
                string keyvaulturi = config["VaultUri"];
                stores.AddAzureKeyVaultWithManagedIdentity(keyvaulturi, CacheConfiguration.Default);
            });
...
//#if DEBUG
            ...
            {
                swaggerUiOptions.SwaggerEndpoint("/api/v1/docs.json", "DevOps.App");
                swaggerUiOptions.RoutePrefix = "api/docs";
                swaggerUiOptions.DocumentTitle = "DevOps.App";
            });
//#endif
