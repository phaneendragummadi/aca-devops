...
using ArmForDummies.App.Models;
using Microsoft.WindowsAzure.Storage;
using Microsoft.WindowsAzure.Storage.Table;
using ConfigurationProvider = ArmForDummies.App.Configuration.ConfigurationProvider;

namespace ArmForDummies.App.Repositories
{
